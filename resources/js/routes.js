const routes = [
    ...
    { path: '/admin/products/:id/edit', name: 'edit-product', component: require('./components/EditProductComponent.vue').default },
    ...
    { path: '/admin/users', component: require('./components/UsersComponent.vue').default  },
    { path: '/admin/passport', component: require('./components/PassportComponent.vue').default  },
